...
has _cfg => ( is => 'ro',
              isa => 'Str',
              default => 'MS::BotBuilder::Configuration',
              );

has version_info => ( is => 'ro', 
                      isa => 'HashRef', 
                      default => sub { {
                          app_name => 'Microsoft Bot Connector API - v3.0',
                          app_version => 'v3',
                          generated_date => '2017-01-13T22:08:02.708Z',
...
sub _build_af {
	...
	return MS::BotBuilder::ApiFactory->new(%args);
}
...
=head2 Microsoft Bot Connector API - v3.0 version: v3
...
=item Build date: 2017-01-13T22:08:02.708Z
...
The tokens will be placed in the C<MS::BotBuilder::Configuration> namespace
as follows, but you don't need to know about this. 

=over 4

=item C<$MS::BotBuilder::Configuration::username>

String. The username for basic auth.

=item C<$MS::BotBuilder::Configuration::password>

String. The password for basic auth.

=item C<$MS::BotBuilder::Configuration::api_key>
...
=item C<$MS::BotBuilder::Configuration::api_key_prefix>
...
=item C<$MS::BotBuilder::Configuration::access_token>
