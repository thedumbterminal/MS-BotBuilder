...
#
package MS::BotBuilder::Object::AnimationCard;
...
__PACKAGE__->class_documentation({description => 'An animation card (Ex: gif or short video clip)',
                                  class => 'AnimationCard',
                                  required => [], # TODO
}                                 );
