...
#
package MS::BotBuilder::Object::Fact;
...
__PACKAGE__->class_documentation({description => 'Set of key-value pairs. Advantage of this section is that key and value properties will be               rendered with default style information with some delimiter between them. So there is no need for developer to specify style information.',
                                  class => 'Fact',
                                  required => [], # TODO
}                                 );
